...
//         // 在选择日期后的回调函数中，可以对选择的日期进行处理
//         // 此处可以根据需要将选择的日期赋值给其他地方，比如表单中的隐藏域等
//         console.log(value); // 打印日期，格式为 yyyy-MM-dd
//         // 假设不允许选择今天之后的日期
//         var today = new Date().toLocaleDateString().replace(/\//g, '-');
//         if (value && value > today) {
//             layer.msg('不能选择今天之后的日期');
//             // 清空输入框的值
//             laydate.elem('#birthday').val('');
//         }
//     }
// });