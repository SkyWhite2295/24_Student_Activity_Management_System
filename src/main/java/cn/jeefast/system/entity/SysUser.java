...
//	@NotNull(message="部门不能为空", groups = {AddGroup.class, UpdateGroup.class})
	...
	private String mibaowenti;
	private String mibaowentidaan;

	public String getMibaowenti() {
		return mibaowenti;
	}

	public void setMibaowenti(String mibaowenti) {
		this.mibaowenti = mibaowenti;
	}

	public String getMibaowentidaan() {
		return mibaowentidaan;
	}

	public void setMibaowentidaan(String mibaowentidaan) {
		this.mibaowentidaan = mibaowentidaan;
	}
