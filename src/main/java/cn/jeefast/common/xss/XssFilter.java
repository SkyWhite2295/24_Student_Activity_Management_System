...
public class XssFilter implements Filter {
	...
	public void init(FilterConfig config) throws ServletException {
		...
		excludedList.add("/sysIndexQd/saveGrrj");
		excludedList.add("/sysXinwen/update");
		excludedList.add("/sysXinwen/save");
		excludedList.add("/sysIndexQd/ydcp");
		excludedList.add("/sysTongzhi/update");
		excludedList.add("/sysTongzhi/save");
		excludedList.add("/sysArticle/update");
		excludedList.add("/sysArticle/save");
		excludedList.add("/sysIndexQd/getpllist");
		excludedList.add("/sysIndexQd/saveBxxx");
		excludedList.add("/sysIndexQd/**");
		...
		excludedList.add("/sysIndexQd/getpllist");
		excludedList.add("/sysIndexQd/saveBxxx");
		excludedList.add("/sysIndexQd/getArticlepllist");
		excludedList.add("/sysIndexQd/getArticle");
		excludedList.add("/sysIndexQd/getXszjnrb");
		excludedList.add("/sysIndexQd/spplArticlesave");
		excludedList.add("/sysIndexQd/ydcp");
		excludedList.add("/sysIndexQd/**");
	}
